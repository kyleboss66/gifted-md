...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~QOom6yd0nYKarkqBtzPE", // Add sess Id here especially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "KYLE BOY", // Input Yours custom...(Maintain font for Flow)
