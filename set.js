...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~6rbP78fMfbw7XZ7KCUeT", // Add sess Id here especially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "255756886492", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "255758640946", // Only 1 owner Number Here, others Add to sudo numbers...
